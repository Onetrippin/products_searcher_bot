data = {
    ...
    'Телевизор': {
        'Бренды': ['DEXP', 'Haier', 'Hisense', 'LG', 'Samsung', 'TCL', 'Xiaomi', 'Accesstyle', 'Aceline', 'AIWA',
                   ...
                   'Doffler'],
        'Параметры': {
            'Диагональ экрана': ['до 31.9\'\'', 'от 32\'\' до 38.9\'\'', 'от 39\'\' до 45.9\'\'', 'от 46\'\' до 64.9\'\'',
                                 'от 65\'\' до 74.9\'\'', 'от 75\'\''],
            'Разрешение экрана': ['HD (1366x768)', 'FullHD (1920x1080)', '4K UltraHD (3840x2160)', '8K UltraHD (7680x4320)'],
            'Smart TV': ['есть'],
            'Операционная система': ['Android', 'Android TV', 'Google TV', 'WebOS', 'YaOS', 'Салют ТВ', 'Tizen', 'Vidaa',
                                     'другая'],
