...
async def filters_command_handler(callback_query: types.CallbackQuery):
...
async def send_filter_page(callback_query: types.CallbackQuery, filter_index: int):
    current_index[callback_query.from_user.id] = filter_index
...
async def filter_navigation(callback_query: types.CallbackQuery):
...
async def select_all_filters(callback_query: types.CallbackQuery):
...
async def select_filter_option(callback_query: types.CallbackQuery):
...
async def clear_filters(callback_query: types.CallbackQuery):
    filter_name = list(FILTERS.keys())[current_index[callback_query.from_user.id]]
    selected_filters[callback_query.from_user.id][filter_name] = []
    await send_filter_page(callback_query, current_index[callback_query.from_user.id])
...
async def filter_counter(callback_query: types.CallbackQuery):
